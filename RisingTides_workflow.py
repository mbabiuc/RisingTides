...
def Run(m=2.8, q=1, rA=12, rB=12, R0=42, χf=0.69, χNS=2.1e-3,q1=0.7,q2=1.4187,q3=-0.499,f1=1.5251,f2=-1.1568,f3=0.1292,E0=0.048332,E2=0.000743,E4=0.000124,MD=0,MTPNf=3455):
    """initialize"""
    ...
    BNS1hplus22=m1*BNS1h22plus[TrefBNS1:-500]
    ...
    BBHhplus22=BBHh22plus[BBH1ωiref:]
    ...
    Time_BNS2h=BBHTime[BBH1ωiref:] - BBHTime[BBH1ωiref]
    ...
    PN_AmpArr_BNS1=AnaBBH1Aintarr[:mrgBNS1index]*(1.+BNS1PNATidearr[0:mrgBNS1index])
    
    #Amplitude for the NRTidal approx until merger (BNS1 comparison)
    NRT_AmpArr_BNS1=AnaBBH1Aintarr[:mrgBNS1index]*(1.+BNS1ATidearr[0:mrgBNS1index])
    
    #Amplitudes for the pN approx until merger (BNS 2 comparison)
    PN_AmpArr_BNS2=AnaBBH2Aintarr[:mrgBNS2index]*(1.+BNS2PNATidearr[0:mrgBNS2index])
    
    #Amplitude for the NRTidal approx until merger (BNS 2 comparison)
    NRT_AmpArr_BNS2=AnaBBH2Aintarr[:mrgBNS2index]*(1.+BNS2ATidearr[0:mrgBNS2index])
    ...
    BNS1ϕTideCor_Fit=BNS1ϕTidemrg_F2[0:mrgBNS1index+4000]
